 ...
 * @author tatuapu
 */
//@WebServlet(name = "autores", urlPatterns = {"/autores"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(cmd.equalsIgnoreCase("listar")){
                List autorList = dao.listaTodos();//recebendo o ArrayList com todos autores
                request.setAttribute("autorList", autorList);//enviando parâmetros via request
